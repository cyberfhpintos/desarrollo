...
from identificador_patente import PatenteSelector
...
class ReconocimientoDatos:
    ...
    def mostrar_ventana_seleccion(self, ruta_pdf):
        """Muestra selector de patente con vista previa del PDF original (usando PyQt5)."""
        ...
        selector = PatenteSelector(ruta_pdf, candidatas)
        selector.show()
        app.exec_()
        ...
        return selector.obtener_resultado()
